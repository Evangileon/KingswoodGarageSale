module Admin
  class Order < ActiveRecord::Base
    ...
    require_dependency 'admin/order/states'
    require_dependency 'admin/order/actions'
    require_dependency 'admin/order/billing'
    require_dependency 'admin/order/delivery'

    # All items which make up this order
    has_many :order_items, :dependent => :destroy, :class_name => 'Admin::OrderItem'
    ...
    has_many :products, :through => :order_items, :class_name => 'Admin::Product', :source => :ordered_item, :source_type => 'Shoppe::Product'
