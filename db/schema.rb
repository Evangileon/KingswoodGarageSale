...
ActiveRecord::Schema.define(version: 20141206055221) do
  ...
  add_index "conversation_users", ["email"], name: "index_conversation_users_on_email", unique: true, using: :btree
  add_index "conversation_users", ["reset_password_token"], name: "index_conversation_users_on_reset_password_token", unique: true, using: :btree
